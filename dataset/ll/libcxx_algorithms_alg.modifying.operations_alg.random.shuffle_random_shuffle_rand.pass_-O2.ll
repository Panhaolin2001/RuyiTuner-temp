; ModuleID = '/root/project/RuyiTuner/third_party/train/llvm-project/libcxx/test/std/algorithms/alg.modifying.operations/alg.random.shuffle/random_shuffle_rand.pass.cpp'
source_filename = "/root/project/RuyiTuner/third_party/train/llvm-project/libcxx/test/std/algorithms/alg.modifying.operations/alg.random.shuffle/random_shuffle_rand.pass.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

$_ZSt16__is_permutationIPiS0_N9__gnu_cxx5__ops19_Iter_equal_to_iterEEbT_S4_T0_T1_ = comdat any

@.str = private unnamed_addr constant [72 x i8] c"std::is_permutation(std::begin(arr), std::end(arr), std::begin(values))\00", align 1
@.str.1 = private unnamed_addr constant [155 x i8] c"/root/project/RuyiTuner/third_party/train/llvm-project/libcxx/test/std/algorithms/alg.modifying.operations/alg.random.shuffle/random_shuffle_rand.pass.cpp\00", align 1
...
@__const._Z18test_with_iteratorIPiEvv.arr = private unnamed_addr constant [4 x i32] [i32 1, i32 2, i32 3, i32 4], align 16
...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef readnone captures(none) %1) local_unnamed_addr #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %5, ptr noundef nonnull align 16 dereferenceable(16) @__const._Z18test_with_iteratorIPiEvv.arr, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %6, ptr noundef nonnull align 16 dereferenceable(16) @__const._Z18test_with_iteratorIPiEvv.arr, i64 16, i1 false)
  %7 = getelementptr inbounds nuw i8, ptr %6, i64 16
  %8 = call noundef zeroext i1 @_ZSt16__is_permutationIPiS0_N9__gnu_cxx5__ops19_Iter_equal_to_iterEEbT_S4_T0_T1_(ptr noundef nonnull %6, ptr noundef nonnull %7, ptr noundef nonnull %5)
  br i1 %8, label %10, label %9

9:                                                ; preds = %2
  call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 43, ptr noundef nonnull @__PRETTY_FUNCTION__._Z18test_with_iteratorI22random_access_iteratorIPiEEvv) #7
  unreachable

10:                                               ; preds = %2
  %11 = call noundef zeroext i1 @_ZSt16__is_permutationIPiS0_N9__gnu_cxx5__ops19_Iter_equal_to_iterEEbT_S4_T0_T1_(ptr noundef nonnull %6, ptr noundef nonnull %7, ptr noundef nonnull %5)
  br i1 %11, label %13, label %12

12:                                               ; preds = %10
  call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 45, ptr noundef nonnull @__PRETTY_FUNCTION__._Z18test_with_iteratorI22random_access_iteratorIPiEEvv) #7
  unreachable
...
13:                                               ; preds = %10
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 16 dereferenceable(16) @__const._Z18test_with_iteratorIPiEvv.arr, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %4, ptr noundef nonnull align 16 dereferenceable(16) @__const._Z18test_with_iteratorIPiEvv.arr, i64 16, i1 false)
  %14 = getelementptr inbounds nuw i8, ptr %4, i64 16
  %15 = call noundef zeroext i1 @_ZSt16__is_permutationIPiS0_N9__gnu_cxx5__ops19_Iter_equal_to_iterEEbT_S4_T0_T1_(ptr noundef nonnull %4, ptr noundef nonnull %14, ptr noundef nonnull %3)
  br i1 %15, label %17, label %16

16:                                               ; preds = %13
  call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 43, ptr noundef nonnull @__PRETTY_FUNCTION__._Z18test_with_iteratorIPiEvv) #7
  unreachable

17:                                               ; preds = %13
  %18 = call noundef zeroext i1 @_ZSt16__is_permutationIPiS0_N9__gnu_cxx5__ops19_Iter_equal_to_iterEEbT_S4_T0_T1_(ptr noundef nonnull %4, ptr noundef nonnull %14, ptr noundef nonnull %3)
  br i1 %18, label %20, label %19

19:                                               ; preds = %17
  call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 45, ptr noundef nonnull @__PRETTY_FUNCTION__._Z18test_with_iteratorIPiEvv) #7
  unreachable
