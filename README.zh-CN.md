...
这个分支包含一个独立的 SPEC CPU2017 测试集适配层。完整流程见
[README_SPEC_CPU2017.md](README_SPEC_CPU2017.md)：从本地已解压的 SPEC CPU2017
目录开始，到生成 linked `.ll`、生成可运行 manifest、普通调优和 pre-O3 调优。
